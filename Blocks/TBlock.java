...
class TBlock extends Block{   
    ...
    TBlock() {
        cords[0] = new int[]{3,1}; cords[1] = new int[]{4,0}; cords[2] = new int[]{4,1}; cords[3] = new int[]{5,1};
        name = "T";
    }
    public void rotate() {
        cords = rotationCords();
    ...
    public int[][] rotationCords() {
        ...
        int[][][] rotating = new int[][][]{new int[][]{new int[]{1,-1},new int[]{1,1},new int[]{0,0},new int[]{-1,1}},new int[][]{new int[]{1,1},new int[]{-1,1},new int[]{0,0},new int[]{-1,-1}}};
        for (int n=0;n<4;n++) {
