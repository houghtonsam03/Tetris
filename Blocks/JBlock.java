...
class JBlock extends Block{
    ...
    JBlock() {
        cords[0] = new int[]{3,0}; cords[1] = new int[]{3,1}; cords[2] = new int[]{4,1}; cords[3] = new int[]{5,1};
        name = "J";
    }
    public void rotate() {
        cords = rotationCords();
    ...
    public int[][] rotationCords() {
        ...
        int[][][] rotating = new int[][][]{new int[][]{new int[]{2,0},new int[]{1,-1},new int[]{0,0},new int[]{-1,1}},new int[][]{new int[]{0,2},new int[]{1,1},new int[]{0,0},new int[]{-1,-1}}};
        for (int n=0;n<4;n++) {
